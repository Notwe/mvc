var EATING_SOUND = new buzz.sound([
    "/public/scripts/main/game/sound/eating.mp3"
]);
var GHOST_EATEN_SOUND = new buzz.sound([
	"/public/scripts/main/game/sound/ghost-eaten.mp3"
]);
var EXTRA_LIFE_SOUND = new buzz.sound([
    "/public/scripts/main/game/sound/extra-life.mp3"
]);
var EAT_PILL_SOUND = new buzz.sound([
    "/public/scripts/main/game/sound/eat-pill.mp3"
]);
var EAT_FRUIT_SOUND = new buzz.sound([
    "/public/scripts/main/game/sound/eat-fruit.mp3"
]);
var EAT_GHOST_SOUND = new buzz.sound([
    "/public/scripts/main/game/sound/eat-ghost.mp3"
]);
var SIREN_SOUND = new buzz.sound([
    "/public/scripts/main/game/sound/siren.mp3"
]);
var WAZA_SOUND = new buzz.sound([
    "/public/scripts/main/game/sound/waza.mp3"
]);
var READY_SOUND = new buzz.sound([
    "/public/scripts/main/game/sound/ready.mp3"
]);
var DIE_SOUND = new buzz.sound([
    "/public/scripts/main/game/sound/die.mp3" 
]);
